...
import TiresBrakesScreen from "../../src/screens/TiresBrakesScreen";

export default function TiresBrakes() {
  ...
  return <TiresBrakesScreen navigation={navigation} route={route} />;
}
